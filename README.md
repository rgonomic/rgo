# rgo [![Build Status](https://www.travis-ci.com/rgonomic/rgo.svg?branch=master)](https://www.travis-ci.com/rgonomic/rgo/branches)
...
```
$ go install github.com/rgonomic/rgo@latest
```
